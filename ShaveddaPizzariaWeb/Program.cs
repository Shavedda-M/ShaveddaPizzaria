...
builder.Services.AddScoped<IPizzaPresetRepository, PizzaPresetRepository>();
builder.Services.AddScoped<IPizzaOrderRepository, PizzaOrderRepository>();
builder.Services.AddScoped<IPizzaOrderDetailRepository, PizzaOrderDetailRepository>();
